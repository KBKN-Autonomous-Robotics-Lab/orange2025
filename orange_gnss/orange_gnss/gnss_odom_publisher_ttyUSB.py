...
class GPSData(Node):
    def __init__(self):
        ...
        self.tsukuba_theta=180.0 # nakaniwa 180
    ...
    def acquire_gps_data(self):
        ...
        if count > 0:
            ...
            self.initial_coordinate = [35.425952230280004, 139.31380123427] # tsukuba start point 36.0497502, 140.0459234 /nakaniwa 35.4257898377487,139.313807281254
